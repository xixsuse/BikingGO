...
public class ItemsTransitStep {
    ...
    public ItemsTransitStep(String distance, String duration, String polyLine, String instructions, LatLng startLatLng, LatLng endLatLng,
                            String travelMode, String transitDepartureStop, String transitArrivalStop,
                            String transitHeadSign, int transitHeadWay, String transitShortName, String transitVehicleType, int transitNumStops)
    {
