...
public class POI extends SQLiteBot {
    ...
    protected POI(Context context, TableName dbTable) {
        super(context.getString(R.string.SQLite_App_Database_Name), context.getString(R.string.SQLite_App_Database_Path),
    ...
    protected void SetupPOI(int poiId) {
        ...
        gpPoi = new GeoPoint(curPOI.getDouble(POIColumn.LONGITUDE.getIndex()), curPOI.getDouble(POIColumn.LATITUDE.getIndex()));
